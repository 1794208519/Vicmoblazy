			...
			<div style="width: 100%; height: 838px; background: url(${ctxStatic}/login/picture/qq_05.png) no-repeat;">
				<div style="width: 1340px;" class="main">
					<div style="background: #fff; margin-top: 175px; border-radius: 5px; padding: 35px;" class="login-box">
						<span style="font-size:24px">找回密码</span>
						<form action="${ctx}/lazyearn/resetdate/jumpList" method="post" id="resttingForm" role="form" onsubmit="return formcheck();">
						...
						<input class="username" id="useraddress" name="useraddress" value="${useraddress}" placeholder="邮箱" type="text" style="margin-top: 30px; border-radius: 5px; background: url(${ctxStatic}/login/picture/login_icon1.png) 10px 50% no-repeat; background-color: #FFF1E8;border-radius: 5px;">
					...
					<div class="input-group" style="margin-top: 8px" >
						<span style="color:red;"><i><sys:message content="${message}"/></i></span>
							...
							<input type="submit" name="submit" value="下一步" class="btn-login" style="background-color:#FFA932; border-radius: 5px; margin-top: 35px; margin-bottom: 20px;" />
